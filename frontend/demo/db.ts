...
const db: DB = {
  ...
  assessments: {
    0: {
      ...
      coverPicture: '/assets/demo/mission-1-cover.png',
    ...
    1: {
      ...
      order: '2',
      title: 'Rune Mastery',
      description: 'Play the game to unlock this mission.',
      published: false,
      coverPicture: '/assets/demo/locked.png',
    ...
    2: {
      ...
      description: 'Play the game to unlock this sidequest.',
      coverPicture: '/assets/demo/locked.png',
